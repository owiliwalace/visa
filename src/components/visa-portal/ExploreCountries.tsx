...
export function ExploreCountries({ onSelectCountry }: { onSelectCountry?: (country: string) => void }) {
  ...
  return (
    <div>
      ...
      <div className="sticky top-20 z-10 bg-gray-50 py-4 mb-6">
      ...
      <div className="mt-16 text-center">
        ...
        <button 
          ...
          className="mt-3 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-indigo-700 bg-indigo-100 hover:bg-indigo-200"
        >
